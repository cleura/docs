---
description: How to monitor Cleura AI token usage
---
...
![Set a date-range and get a daily token usage, broken down by model](assets/token-usage-day_light.png#only-light)
![Set a date-range and get a daily token usage, broken down by model](assets/token-usage-day_dark.png#only-dark)
