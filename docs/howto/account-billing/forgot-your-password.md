...
![Forgot your password button](assets/Forgot-your-password_light.png#only-light)
![Forgot your password button](assets/Forgot-your-password_dark.png#only-dark)

A pop-up window titled "Reclaim lost password!", appears.
Type in your username, then click on the "Reclaim password!" button.

![Reclaim password button](assets/Reclaim-lost-password_light.png#only-light)
![Reclaim password button](assets/Reclaim-lost-password_dark.png#only-dark)
...
![Reset your password email](assets/Reset-password-link_light.png#only-light)
![Reset your password email](assets/Reset-password-link_dark.png#only-dark)

After clicking the link you are landed on a new page, where you are asked to set a new password.

![Type in new password](assets/Choose-new-password_light.png#only-light)
![Type in new password](assets/Choose-new-password_dark.png#only-dark)
...
![Password succesfully changed](assets/Reset-completed_light.png#only-light)
![Password succesfully changed](assets/Reset-completed_dark.png#only-dark)
...
![Reclaim lost password pop-up](assets/Forgot-your-password_light.png#only-light)
![Reclaim lost password pop-up](assets/Forgot-your-password_dark.png#only-dark)

A pop-up window titled "Reclaim lost password!" appears.
Ignore the "Reclaim password!" button, and follow the link "I don't know my username" instead.

![Forgotten username link](assets/Reclaim-my-username_light.png#only-light)
![Forgotten username link](assets/Reclaim-my-username_dark.png#only-dark)
...
![Reclaim username button](assets/Reclaim-lost-username_light.png#only-light)
![Reclaim username button](assets/Reclaim-lost-username_dark.png#only-dark)
...
![Usernames associated with account](assets/List-of-username_light.png#only-light)
![Usernames associated with account](assets/List-of-username_dark.png#only-dark)
