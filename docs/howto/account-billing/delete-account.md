...
From the vertical pane on the left, select *Settings* and then *Manage Account*.

In the central *Account Settings* pane, click the *Delete Account* tab on the right.
...
At the bottom of the tab, click the button named *Delete Account*.
...
Click the button named *Delete Account* one more time.
