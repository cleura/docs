...
![A 'Contact' tab showing a newly added email address for the 'DPO' role](assets/emaildone_light.png#only-light)
![A 'Contact' tab showing a newly added email address for the 'DPO' role](assets/emaildone_dark.png#only-dark)
...
![The 'Email Address' table, showing two remaining email addresses](assets/left_light.png#only-light)
![The 'Email Address' table, showing two remaining email addresses](assets/left_dark.png#only-dark)
...
![The 'Email Address' table with changed role associations](assets/changedone_light.png#only-light)
![The 'Email Address' table with changed role associations](assets/changedone_dark.png#only-dark)
